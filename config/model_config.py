...
MODEL_CONFIGS: List[ModelConfig] = [
    ...
    # Anthropic
    ModelConfig(id="claude-opus-4.5", name="Claude Opus 4.5", context_length=200000),
    ModelConfig(
        id="claude-sonnet-4.5", name="Claude Sonnet 4.5", context_length=200000
    ),
    ModelConfig(id="claude-haiku-4.5", name="Claude Haiku 4.5", context_length=200000),
    # Google
    ModelConfig(id="gemini-3-pro", name="Gemini 3 Pro", context_length=1000000),
    ModelConfig(id="gemini-3-flash", name="Gemini 3 Flash", context_length=1000000),
    # DeepSeek
    ModelConfig(id="deepseek-v3.1", name="DeepSeek V3.1", context_length=128000),
    ModelConfig(id="deepseek-r1", name="DeepSeek R1", context_length=128000),
    # xAI
    ModelConfig(id="grok-4", name="Grok 4", context_length=256000),
    # Alibaba
    ModelConfig(id="qwen3-235b", name="Qwen3 235B", context_length=256000),
    # Meta
    ModelConfig(id="llama-4-scout", name="Llama 4 Scout", context_length=10000000),
]
