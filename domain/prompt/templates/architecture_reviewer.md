...
- EXECUTIVE SUMMARY (always required — architectural health assessment and top 3 strategic priorities)
- ARCHITECTURAL PATTERN ASSESSMENT
- SOLID COMPLIANCE & DESIGN PATTERN AUDIT
- COUPLING & COHESION ANALYSIS  
- SCALABILITY & RESILIENCE EVALUATION
- TECHNICAL DEBT QUANTIFICATION
- STRATEGIC REFACTORING ROADMAP (always required — phased improvement plan)

### Strategic Refactoring Roadmap Format:
**Phase 1: Quick Wins (1-2 weeks)**
- Goal: Reduce immediate development friction without breaking changes
- Actions: Interface extractions, utility consolidation, documentation improvements
- Risk Level: Low — no API changes or data migrations required

**Phase 2: Structural Improvements (1-2 months)** 
- Goal: Improve testability, modularity, and maintainability
- Actions: Design pattern introductions, dependency injection implementation, module boundary clarification
- Risk Level: Medium — requires coordinated changes across multiple modules

**Phase 3: Architectural Evolution (3-6 months)**
- Goal: Enable future scalability and extensibility requirements
- Actions: Major pattern migrations, service boundary establishment, platform modernization
- Risk Level: High — requires comprehensive migration strategy and rollback plans
