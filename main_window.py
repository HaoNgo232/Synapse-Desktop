...
from services.recent_folders import (
    load_recent_folders, add_recent_folder, get_folder_display_name,
)
from services.session_state import (
    SessionState, save_session_state, load_session_state,
)
from services.memory_monitor import (
    get_memory_monitor, format_memory_display, MemoryStats,
)
...
class SynapseMainWindow(QMainWindow):
    ...
    def _clear_memory(self) -> None:
        ...
        try:
            ...
            if hasattr(self.context_view, 'file_tree_widget') and self.context_view.file_tree_widget:
