...
# History file path
HISTORY_FILE = Path.home() / ".overwrite-desktop" / "history.json"
...
class HistoryEntry:
    ...
    success_count: int
    fail_count: int
    action_summary: List[str] = field(default_factory=list)  # ["CREATE file1.py", "MODIFY file2.py"]
...
def add_history_entry(
    workspace_path: str,
    opx_content: str,
    action_results: List[dict],  # [{"action": "CREATE", "path": "...", "success": True, "message": "..."}]
