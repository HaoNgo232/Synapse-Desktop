...
def test_paas_k3s_performance():
    ...
    print(f"    Time: {time_without:.2f}s ({time_without*1000/len(files):.1f}ms per file)")
    ...
    print(f"    Time: {time_with_nocache:.2f}s ({time_with_nocache*1000/len(files):.1f}ms per file)")
    ...
    print(f"    Time: {time_with_cache:.2f}s ({time_with_cache*1000/len(files):.1f}ms per file)")
    ...
    print(f"With relationships (cold): {time_with_nocache:.2f}s ({((time_with_nocache/time_without - 1) * 100):.1f}% overhead)")
    print(f"With relationships (warm): {time_with_cache:.2f}s ({time_with_nocache/time_with_cache:.1f}x speedup)")
